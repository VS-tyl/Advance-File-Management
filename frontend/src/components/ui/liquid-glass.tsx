...
const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    ...
    >
      ...
      <div className="absolute inset-0 z-[15] overflow-hidden rounded-inherit pointer-events-none">
        <div className="absolute -inset-[200%] bg-gradient-to-r from-transparent via-white/10 to-transparent rotate-12 animate-[glassSweep_8s_linear_infinite]" />
      </div>
...
const GlassDock: React.FC<{ icons: DockIcon[]; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl p-3 hover:p-4 hover:rounded-[40px]"
  >
...
const GlassButton: React.FC<{ children: React.ReactNode; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl px-10 py-6 hover:px-11 hover:py-7 hover:rounded-[40px] overflow-hidden"
  >
    <div
